...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MyXs"));
    case mBTC: return QString(QObject::tr("Milli-MyXs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MyXs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
