...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("myx://"))
    {
        uri.replace(0, 10, "myx:");
    }
...
void openConfigfile()
{
    ...
    /* Open myx.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "MyX.lnk";
}
...
{
    return GetAutostartDir() / "myx.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("MyX-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  myx-qt [" + tr("command-line options") + "]                     " + "\n";
